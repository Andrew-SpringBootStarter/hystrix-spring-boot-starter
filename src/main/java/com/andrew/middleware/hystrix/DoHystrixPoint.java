package com.andrew.middleware.hystrix;

import com.andrew.middleware.hystrix.annotation.DoHystrix;
import com.andrew.middleware.hystrix.valve.IValveService;
import com.andrew.middleware.hystrix.valve.impl.HystrixValveImpl;
...
public class DoHystrixPoint {
    ...
    @Pointcut("@annotation(com.andrew.middleware.hystrix.annotation.DoHystrix)")
